...
function Welcome() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-umat-green via-emerald-800 to-umat-gold overflow-hidden relative">
      {/* Animated background elements */}
      <div className="absolute inset-0">
        <div className="absolute top-20 left-10 w-72 h-72 bg-umat-gold/20 rounded-full blur-3xl animate-pulse"></div>
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-8 text-white">
        <div className="text-center w-full">
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-black bg-gradient-to-r from-yellow-300 via-umat-gold to-emerald-400 bg-clip-text text-transparent mb-12 drop-shadow-4xl leading-tight">
            IMAKS
          </h1>
          ...
          <div className="flex flex-col lg:flex-row gap-8 justify-center items-center mb-20">
            <a 
              href="/login" 
              className="bg-gradient-to-r from-umat-gold to-yellow-500 text-black font-black py-6 px-12 rounded-3xl text-xl hover:from-yellow-400 hover:to-umat-gold hover:scale-110 transition-all duration-300 shadow-2xl hover:shadow-4xl transform hover:-translate-y-2"
            >
              🚀 Get Started
            </a>
            <a 
              href="/signup" 
              className="border-4 border-white/30 bg-white/5 backdrop-blur-2xl text-white font-bold py-6 px-12 rounded-3xl text-xl hover:bg-white/20 hover:border-umat-gold hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-3xl"
            >
              New User? Join Now
            </a>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto opacity-80">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-bold mb-2 text-umat-gold drop-shadow-lg">Knowledge Library</h3>
